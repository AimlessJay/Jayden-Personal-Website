...
`skill_id`       int(11)       NOT NULL AUTO_INCREMENT 	COMMENT 'The experiences id',
`xp_id`          int(11)       NOT NULL             COMMENT 'FK:position id from experiences table',
...
FOREIGN KEY (xp_id) REFERENCES experiences(xp_id)
