...
`xp_id`          int(11)       NOT NULL AUTO_INCREMENT 	COMMENT 'The experiance id',
`position_id`    int(11)       NOT NULL                 COMMENT 'FK:position id from positions table',
`name`           varchar(100)  NOT NULL                 COMMENT 'The name of the experiance',
`description`    varchar(500)  NOT NULL             	COMMENT 'Description of experiance',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT="Experiance i've had";